...
<div class="container p-4" id="container-edicion">
  <div class="row">
    ...
    <form class="form-horizontal" action="<?= URL; ?>administracion/actualizarAptos" method="post" enctype="multipart/form-data" autocomplete="off">
      <div class="col-xs-12 col-sm-12 col-md-4">
        <button type="submit" name="btneditaraptos" id="actualizar">Actualizar</button>
      </div>
  </div>
  <br />
  <br />
